...
const About = () => {
  ...
  const persons = [
    { name: "Oscar Gregorius", nr: "0728492302", email: "oscar@clearbnb.se" },
    { name: "Ali Al-Mousawi", nr: "0728492302", email: "ali@clearbnb.se" },
    { name: "Jonathan Persson", nr: "0728492302", email: "jonathan@clearbnb.se" },
    { name: "Simon Richter", nr: "0728492302", email: "simon@clearbnb.se" }
  ];
